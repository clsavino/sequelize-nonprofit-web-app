...
router.get('/index', function (req, res) {
    res.render("index", {title: "OCIM Home", isIndex: true});
  });

// get all events from database and display on page
router.get('/events', function (req, res) {
    models.events.findAll({}).then(function(data) {
    res.render("events", {events: data, title: "OCIM Events", isEvents: true});
  });
});

router.get('/aboutUs', function (req, res) {
    res.render("aboutUs", {title: "OCIM About Us", isAboutUs: true});
  });

router.get('/contactUs', function (req, res) {
    res.render("contactUs", {title: "OCIM Contact Us", isContactUs: true});
  });

router.get('/giftIdeas', function (req, res) {
    res.render("giftIdeas", {title: "OCIM Gift Ideas", isGiftIdeas: true});
  });

router.get('/volunteer', function (req, res) {
    res.render("volunteer", {title: "OCIM Volunteer", isVolunteer: true});
  });

router.get('/donate', function (req, res) {
    res.render("donate", {title: "OCIM Donate", isDonate: true});
  });
...
router.get('/adminMealsSchedule', auth, function (req, res) {
    ...
    res.render("adminMealsSchedule", {mealsonwheels: data, title: "Admin Meals Schedule", isAdminMealsSchedule: true, showAdminNav: true});
  });
});
...
router.get('/adminVolunteers', auth, function (req, res) {
    ...
    res.render("adminVolunteers", {Volunteers: data, title: "Admin Volunteers", isAdminVolunteers: true, showAdminNav: true});
  });
});
...
router.get('/adminEvents', auth, function (req, res) {
    models.events.findAll({}).then(function(data) {
    res.render("adminEvents", {events: data, title: "Admin Events", isAdminEvents: true, showAdminNav: true});
  });
});
